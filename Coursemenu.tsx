    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('Homescreen')}>
          <Image
            source={{ uri: 'https://snack-code-uploads.s3.us-west-1.amazonaws.com/~asset/efa234ccf71edf969e8915f284ce657b' }} // brand logo
            style={styles.logo}
          />
        </TouchableOpacity>
        <Text style={styles.menuHeaderText}>Menu Categories</Text>
      </View>
