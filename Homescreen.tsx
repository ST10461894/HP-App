  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Hot-Pot (home)</Text>
      </View>
      <Image
        source={{ uri: 'https://snack-code-uploads.s3.us-west-1.amazonaws.com/~asset/697d48e15dae8571db6412f475946b4d' }} 
        style={styles.image}
      />
      ...
      <View style={styles.navButtonContainer}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => navigation.navigate('Coursemenu', { menuItems })} 
        >
          <Text style={styles.navButtonText}>{">"}</Text>
        </TouchableOpacity>
      </View>
